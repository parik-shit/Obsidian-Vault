...
   // Pipe stdout of the child process to Node.js console
...
    res.send(data.toString()); // Send stdout data as response
...
// Ensure that the pythonProcess variable is null on server start/restart (redundant now)
